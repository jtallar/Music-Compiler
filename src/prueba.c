...
int main(){
    ...
    Set setfc[28] = {{realChords[aC], 500}, {realChords[aC], 500}, {realChords[aD], 500},{realChords[aC], 500}, {realChords[aF], 500}, {realChords[aE], 800}, {noteChords[_], 1000},
        ...
        {realChords[aC], 500}, {realChords[aC], 500}, {realChords[aC], 500},{realChords[aA], 500}, {realChords[aF], 500}, {realChords[aE], 500}, {realChords[aD], 800}, {noteChords[_], 1000},
